...
# use this to test a fully trained model
def TestNetworkNotTraining(dataset_directory, batch_size, model_path, output_pdf_path):
        ...
        # predefine rectangles for photos per page (15 per page).. later on maybe locations will want to be dynamic but for now we will keep reporting assumed to be >
